...
//
// Live scan:  Rare, Exceptional, or NahiTouched (per CreatureDataSO.AliveTier)
...
//
// V7 naming pass: AurTouched → NahiTouched
// ─────────────────────────────────────────────────────────────────────────────
...
namespace TerrasHeart.Scanner
{
    public enum SpecimenTier
    {
        ...
        Rare = 2,
        Exceptional = 3,
        NahiTouched = 4   // Only available in healthy biomes with Nahî-adjacent creatures
    }
}